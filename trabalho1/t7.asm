...
start:
    ...
    invoke WriteConsole, outputHandle4, addr numIn, tamanho_string4, addr console_count4, NULL
    ...
    colorir:
        ...
        mov ecx, numCanal1
        ;mov dl, numInserido
        ;printf("%d\n", BYTE PTR numInserido)
  
        mov bl, BYTE PTR [fileBuffer+ecx]
        add bl, BYTE PTR numInserido
        mov BYTE PTR [fileBuffer+ecx], bl
        ;printf("%d\n", ecx)
        cmp bl, BYTE PTR numInserido ;registrador/memória,constante
        jb limiter
